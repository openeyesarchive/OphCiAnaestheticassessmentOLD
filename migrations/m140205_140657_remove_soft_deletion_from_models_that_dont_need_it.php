...
class m140205_140657_remove_soft_deletion_from_models_that_dont_need_it extends CDbMigration
{
	public $tables = array(
		'et_ophcianaestheticassessmen_asa',
		'et_ophcianaestheticassessmen_examination',
		'et_ophcianaestheticassessmen_history',
	);
