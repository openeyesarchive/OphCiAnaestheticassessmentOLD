...
class OphCiAnaestheticassessmentModule extends BaseEventTypeModule
{
	...
	public function init() {
		...
		$this->setImport(array(
			'OphCiAnaestheticassessment.models.*',
			'OphCiAnaestheticassessment.components.*',
		));
		
		$this->moduleShortSuffix = "anaestheticassessmen";
	}
